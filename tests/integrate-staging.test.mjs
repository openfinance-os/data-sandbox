...
if (!SITE_STAGED) {
  ...
  it('raw HTTPS fixture URLs are staged at /fixtures/v1/ (EXP-28)', () => {
    ...
    // 18 banking + 7 insurance preview (3 motor + 1 home + 1 health + 1 life
    // + 1 travel) = 25 personas × 3 LFIs = 75 fixtures.
    expect(Object.keys(manifest.personas).length).toBe(25);
    expect(Object.keys(manifest.fixtures).length).toBe(75);
