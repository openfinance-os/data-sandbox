...
if (!FIXTURES_BUILT) {
  ...
  it('manifest.json indexes 18 banking + 5 insurance personas × 3 LFIs', () => {
    ...
    expect(Object.keys(m.personas).length).toBe(23);
    expect(Object.keys(m.fixtures).length).toBe(69); // 23 × 3
  ...
  it('ESM loader works — listPersonas + loadFixture + loadSpec', async () => {
    ...
    expect(m.listPersonas({ domain: 'insurance' }).length).toBe(5);
