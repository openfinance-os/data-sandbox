...
if (!FIXTURES_BUILT) {
  ...
  it('manifest.json indexes 18 banking + 4 insurance personas × 3 LFIs', () => {
    ...
    expect(Object.keys(m.personas).length).toBe(22);
    expect(Object.keys(m.fixtures).length).toBe(66); // 22 × 3
    ...
    expect(byDomain).toEqual({ banking: 18, insurance: 4 });
  ...
  it('ESM loader works — listPersonas + loadFixture + loadSpec', async () => {
    ...
    expect(m.listPersonas({ domain: 'insurance' }).length).toBe(4);
