...
if (!FIXTURES_BUILT) {
  ...
  it('manifest.json indexes 18 banking + 6 insurance personas × 3 LFIs', () => {
    ...
    expect(Object.keys(m.personas).length).toBe(24);
    expect(Object.keys(m.fixtures).length).toBe(72); // 24 × 3
  ...
  it('ESM loader works — listPersonas + loadFixture + loadSpec', async () => {
    ...
    expect(personas.length).toBe(24);
    expect(m.listPersonas({ domain: 'banking' }).length).toBe(18);
    expect(m.listPersonas({ domain: 'insurance' }).length).toBe(6);
