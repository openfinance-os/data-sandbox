...
if (!FIXTURES_BUILT) {
  ...
  it('manifest.json indexes 17 banking + 3 insurance personas × 3 LFIs', () => {
    ...
    expect(Object.keys(m.personas).length).toBe(20);
    expect(Object.keys(m.fixtures).length).toBe(60); // 20 × 3
    ...
    expect(byDomain).toEqual({ banking: 17, insurance: 3 });
  ...
  it('ESM loader works — listPersonas + loadFixture + loadSpec', async () => {
    ...
    expect(m.listPersonas({ domain: 'banking' }).length).toBe(17);
