...
Distinct from the *user* archetypes above, the sandbox ships a curated library of synthetic UAE customer personas. **As of v2.0 the library is 12 banking personas + 3 insurance preview personas.** Users load these to explore the data:
